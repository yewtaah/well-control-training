...
export function CourseCertificate({
  ...
  return (
    <Certificate
      ...
      statement={`has completed every lesson in this course and passed the knowledge check with ${completion.quizPercent}%, meeting the WellCommand Assurance standard for`}
